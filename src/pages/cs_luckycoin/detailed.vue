        ...
        <div class="main" v-if="goodsinfo">
                    ...
                    <div class="match-img">
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="110" height="110">
                            ...
                            <g transform="matrix(0,-1,1,0,0,110)">
                                ...
                                <circle cx="55" cy="55" r="50" stroke="url(#yellowColor1)" stroke-width="10" fill="transparent" :stroke-dasharray="`${rate > 157 ? rate : 0} 314`" />
                                <circle cx="55" cy="55" r="50" stroke="url(#yellowColor2)" stroke-width="10" fill="transparent" :stroke-dasharray="`${rate > 157 ? 157 : rate} 314`" />
                            </g>
                        </svg>
                    </div>
                        ...
                        <div class="cc-group cc-luckycoin" v-if="coinType !== '2000' && isLogin">
                            ...
                            <a href="javascript:;" class="btn-cc">
                                ...
                                <div>
                                    ...
                                    <p v-html="_($lang.risk.a18, getCCDeductionMoney(betValue, userInfo.discount_cfg.limit_rate['2']) + coinText)"></p>
            ...
            <div class="main-detailed">
                ...
                <el-table :data="totalBids" style="width: 100%" :default-sort="{prop: 'date', order: 'descending'}" v-show="activeName === 'all' && totalBids.length > 0" :row-class-name="getRowClass">
                    ...
                    <el-table-column :label="_('Amount')" width="144">
                        <template slot-scope="scope">
                    ...
                    <el-table-column prop="number" :label="_('Number')" width="274">
                        <template slot-scope="scope">
                ...
                <div class="mybets" v-if="myNumbers.length > 0 && activeName === 'my'">
                    ...
                    <p class="msg2">
                        <lang>Winner takes all reward!</lang>
                        <router-link :to="`/check?number=${number}&type=luckycoin`">
                            <lang>Click here to see transparent information.</lang>
                        </router-link>
                    </p>
                </div>
                ...
                <el-pagination @current-change="handleAllBidsChange" :current-page.sync="pageno" :page-size="pageSize" :page-count="PageTotal" layout="prev, pager, next" :next-text="_('Next >')" :prev-text="_('< Previous')" v-if="activeName === 'all' && PageTotal !== 0">
                </el-pagination>
            </div>
            <!--投注记录弹窗-->
