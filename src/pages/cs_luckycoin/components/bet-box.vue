        ...
        <div class="match-img" :class="[coin.boxClass]">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="102" height="102">
                ...
                <g transform="matrix(0,-1,1,0,0,102)">
                    ...
                    <circle cx="51" cy="51" r="47" stroke="url(#yellowColor1)" stroke-width="8" fill="transparent" :stroke-dasharray="`${rate>148?rate:0} 296`" />
                    <circle cx="51" cy="51" r="47" stroke="url(#yellowColor2)" stroke-width="8" fill="transparent" :stroke-dasharray="`${rate > 148 ? 148 : rate} 296`" />
                </g>
                <!--
