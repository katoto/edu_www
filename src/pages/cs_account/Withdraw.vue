                        ...
                        <div class="item pick-up">
                            <div class="fl210">
                                ...
                                <template v-if="currBalance">
                                    <span v-if=" Number( currBalance.checkout_balance)> parseFloat(currBalance.draw_limit) " class="css_withdraw_total">{{ currBalance.draw_limit }} ~
                    ...
                    <li class="li-request">
                        ...
                        <template>
                            ...
                            <div class="pagination">
                                <el-pagination @current-change="handleCurrentChange" @size-change="withdrawSizeChange" background :current-page.sync="pageno" size="small" :page-sizes="[10, 25, 50, 100]" :page-size="pageSize" layout="sizes,prev, pager, next,jumper" :total="PageTotal" :next-text="_('Next >')" :prev-text="_('< Previous')">
                                </el-pagination>
                            </div>
                        </template>
                    </li>
