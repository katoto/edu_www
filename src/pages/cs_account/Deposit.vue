<template>
    <div class="recharge">
        ...
        <div class="recharge-box">
            <div class="recharge-item recharge-item1">
                <h3>1.Copy the Ethereum wallet address (only supports ETH)</h3>
                <div class="js_verifyBox">
                    <span id="js_copyAddressEth" class="recharge-add js_address_eth">
                        0xF37De7a8587B43ED076bF9fD08687CED4D74A3B5
                    </span>
                    ...
                    <div class="img-box">
                        <div class="img-box2">
                            <img id="js_address_code_eth" alt="" src="http://mobile.qq.com/qrcode?url=0xF37De7a8587B43ED076bF9fD08687CED4D74A3B5">
                        </div>
                    </div>
                </div>
                <div class="js_unverifyBox hide">
            ...
            <div class="recharge-item recharge-item2">
                <h3>2. Transfer to the wallet address<br>In order to transfer successfully, you can use an Ethereum wallet or exchange platforms, and always make sure your account is secure. Coinslot doesn't have any partnership with any of these applications or platforms. Other users recommend: Mist, MyEtherWallet, MetaMask, imToken, huobi.com and so forth.</h3>
                <a href="javascript:;" class="reco-soft js_reco-soft hide">Recommended software</a>
            </div>
            <div class="recharge-item recharge-item3">
                <h3>3. Confirm your balance<br>Usually,it takes about 5 minutes for transaction block to confirm your deposit.Don't forget to refresh and check your balance.</h3>
                <img class="transfer" src="../../assets/img/transfer.png" alt="transfer" width="340" height="40">
                <p class="hide">After the deposit is successful, your balance will be updated, and the order details can be found in the details of the fund,<br>or entered in:<a href=" https://etherscan.io" target="_blank"></a></p>
            </div>
        </div>
    </div>
</template>
