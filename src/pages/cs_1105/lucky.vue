    ...
    .play-type-choose {
      ...
      > span {
        ...
        &::after {
          ...
          width: 19/2px;
          height: 11/2px;
          background: url(../../assets/img/lucky11/btn-close.png) no-repeat
            center;
    ...
    .beting {
      ...
      .input-box {
        ...
        div {
          ...
          &.icon-btc::after {
            background: url("../../assets/img/lucky11/icon-btc.png") no-repeat
              center;
            background-size: cover;
          }
          &.icon-eth::after {
            background: url("../../assets/img/lucky11/icon-eth.png") no-repeat
              center;
            background-size: cover;
          }
        }
