    ...
    <div id="lucky11" :class="{'superActive':superClass}" >
        ...
        <div>
            ...
            <div class="h5main  hidden-lg "  @click="initPop">
                ...
                <div class="play-area">
                    <ul class="play-area-items">
                        <H5PlayArea v-for="(item,index) in playArea" :key="index" :currIndex.sync="index"
                                  :allplayArea.sync="playArea" :areaMsg="item"
                                  :data.sync="playArea[index]">
        ...
        <div class="pop pop-jackpot"  v-if="jackPotMsg && jackPotMsg.length > 0">
            <div class="bg-jackpot ">
                <p class="jack-msg1">
                 ...
                 <p class="jack-msg3" v-if="jackPotMsg[0]">{{jackPotMsg[0].prize | formateBalance}}<i>{{jackPotMsg[0].cointype | formateCoinType }}</i></p>
            ...
            format_recentWins (msg) {
                if (msg) {
                    msg.forEach((item, index) => {
                        ...
                        item.betprize = '<a class="win"><span>' + formateBalance(parseFloat(item.betprize)) + '</span>' + formateCoinType(item.cointype) + '</a>'
                    })
                }
                return msg
            },
...
<style lang="less" type="text/less" >
        ...
        .play-area{
           ...
           margin: 0 auto;
                ...
                .slide{
                    ...
                    .super_li{
                        ...
                        &::after{
                            ...
                            width: 126/2px;
                            height: 42/2px;
                            background: url("../../assets/img/lucky11/icon-jackpot.png") no-repeat center;
            ...
            .btn-delete{
                ...
                margin-right: 10px;
                border-radius:6px;
                background:#473c8f url("../../assets/img/lucky11/btn-delete.png") no-repeat center;
            ...
            .beting{
                ...
                .input-box{
                    ...
                    div{
                        ...
                        &.icon-btc::after{
                            background: url("../../assets/img/lucky11/icon-btc.png") no-repeat center;
                            background-size: cover;
                        }
                        &.icon-eth::after{
                            background: url("../../assets/img/lucky11/icon-eth.png") no-repeat center;
                            background-size: cover;
                        }
                    }
                }
    ...
    .superActive {
        ...
        .h5main{
            background: #7c6138;
            .play-area{
                .play-type-choose,.btn-random-pick,.btn-delete,.pop-reward-ct,.beting .input-box a{
