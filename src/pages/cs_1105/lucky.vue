    ...
    methods: {
            ...
            if (this.playArea) {
                ...
                if (noComplete.length === 0) {
                    ...
                    noCompleteIndex.forEach((val, index) => {
                        if (
                            document.querySelectorAll('.play-area-items .js_playArea-li')[val]
                        ) {
                            document.querySelectorAll('.play-area-items .js_playArea-li')[
                                val
                            ].className =
                'js_playArea-li'
                            document.querySelectorAll('.play-area-items .js_playArea-li')[
        ...
        format_recentWins (msg) {
            msg.forEach((item, index) => {
                ...
                item.betprize =
          '<span class="win"><span>' +
          parseFloat(item.betprize).toFixed(5) +
          '</span>ETH</span>'
            })
            return msg
        },
