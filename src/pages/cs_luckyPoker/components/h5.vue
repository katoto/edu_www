            ...
            ul{
                ...
                li.on{
                    ...
                    &::before{
                        ...
                        display: block;
                        position: absolute;
                        width: percentage(90/104);
                        height: percentage(90/104);
                        left: 50%;
                        top: 50%;
                        transform: translate(-50%,-50%);
                        border-radius: 50%;
