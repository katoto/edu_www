                            ...
                            <div class="cc-group cc-luckyPokerPc" v-if="coinType !== '2000' && isLogin">
                                ...
                                <a href="javascript:;" class="btn-cc">
                                    ...
                                    <div>
                                        ...
                                        <p v-html="_($lang.risk.a18, getCCDeductionMoney(total, userInfo.discount_cfg.limit_rate['4']) + coinText)"></p>
  ...
  * {
      ...
      .btn-cls {
        ...
        a {
          ...
          &::before {
            content: "";
            display: block;
            background: url("../../assets/img/luckyPoker/icon-cls.png")
              no-repeat center;
          }
        }
      }
  ...
  .area-btn {
    ...
    .btn-main {
      ...
      justify-content: center;
      cursor: pointer;
      background: url("../../assets/img/luckyPoker/btn-main.png") no-repeat
        center;
  ...
  .poker-history {
    ...
    .btn-left {
      background: url("../../assets/img/luckyPoker/icon-left.png") no-repeat
        center;
    }
    .btn-right {
      background: url("../../assets/img/luckyPoker/icon-right.png") no-repeat
        center;
    }
    .poker-item {
      flex: 1;
    ...
    li {
      ...
      &.icon-heit {
        color: #000000;
        &::after {
          background: url("../../assets/img/luckyPoker/icon-heit.png") no-repeat
            center top;
          background-size: contain;
        }
      }
  ...
  .recording {
    ...
    .recording-top {
      ...
      a {
        ...
        &.on {
          &::before {
            background: url("../../assets/img/luckyPoker/icon-my.png") no-repeat
              left top;
  ...
  .pop-poker {
    ...
    .result {
      ...
      transform-origin: center;
      &.isWin {
        background: url("../../assets/img/luckyPoker/bg-win.png") no-repeat
          center bottom;
    ...
    .result-box {
      ...
      &.j {
        .img-poker {
          background: url("../../assets/img/luckyPoker/icon-J.png") no-repeat
            center;
      ...
      &.q {
        .img-poker {
          background: url("../../assets/img/luckyPoker/icon-Q.png") no-repeat
            center;
          background-size: percentage(300/360);
        }
      }
      &.k {
        .img-poker {
          background: url("../../assets/img/luckyPoker/icon-K.png") no-repeat
            center;
          background-size: percentage(300/360);
        }
      }
      &.joker {
        background: url("../../assets/img/luckyPoker/icon-Joker.png") no-repeat
          center;
        background-size: cover;
        * {
...
@media (max-width: 1106px) {
  .luckyPoker {
    ...
    .bg-esktop {
      width: 100%;
      position: relative;
      background: url("../../assets/img/luckyPoker/bg.jpg") repeat-y center
        bottom;
      background-size: cover;
      padding-bottom: 30px;
      &::before {
      ...
      &::after {
        ...
        width: 100%;
        height: 400/2px;
        background: url("../../assets/img/luckyPoker/bg-border.png") no-repeat
          center bottom;
        background-size: 100%;
      }
    }
    ...
    .area-betting {
      ...
      background: url("../../assets/img/luckyPoker/bg-ligth.png") no-repeat
        center;
      background-size: cover;
      font-weight: bold;
      .bet-rb {
    ...
    .area-btn {
      ...
      .btn-main {
        ...
        p {
          line-height: 22px;
          font-size: 14px;
          text-shadow: 0 1px #2b7b75, 1px 0 #2b7b75, -1px 0 #2b7b75,
            0 -1px #2b7b75;
        }
        span {
          line-height: 15px;
    ...
    .area-random {
      ...
      .random-top {
        ...
        .btn-help {
          ...
          height: 86/2px;
          overflow: hidden;
          background: url("../../assets/img/luckyPoker/icon-help.png") no-repeat
            center;
        ...
        .btn-slideUp {
          ...
          height: 86/2px;
          overflow: hidden;
          background: url("../../assets/img/luckyPoker/icon-bottom.png")
      ...
      .recording-top {
        ...
        a {
          ...
          &::before {
            ...
            width: 21px;
            height: 19px;
            background: url("../../assets/img/luckyPoker/icon-all.png")
              no-repeat left top;
            background-size: 21px;
          }
          &.on {
            &::before {
              background: url("../../assets/img/luckyPoker/icon-my.png")
                no-repeat left top;
              background-size: 21px;
            }
          }
          ...
          li {
            ...
            .bet-result {
              ...
              &.icon-fk {
                color: #cc3333;
                &::after {
                  background: url("../../assets/img/luckyPoker/icon-fk.png")
                    no-repeat center top;
                  background-size: contain;
                }
              }
              &.icon-mh {
                color: #000000;
                &::after {
                  background: url("../../assets/img/luckyPoker/icon-mh.png")
                    no-repeat center top;
                  background-size: contain;
                }
              }
...
@media (min-width: 1106px) {
  .luckyPoker {
    background: #1b262c url("../../assets/img/luckyPoker/bg-pc.jpg") no-repeat
      center top;
    ...
    .bg-pc-esktop {
      ...
      height: 864px;
      font-weight: bold;
      background: url("../../assets/img/luckyPoker/bg-pc-desktop.png") no-repeat
        center top;
    ...
    .area-btn {
      ...
      .btn-main {
        ...
        p {
          line-height: 28px;
          font-size: 26px;
          text-shadow: 0 2px #2b7b75, 2px 0 #2b7b75, -2px 0 #2b7b75,
            0 -2px #2b7b75;
        }
        span {
          line-height: 20px;
