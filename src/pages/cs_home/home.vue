                    ...
                    <div class="col-xs-12 col-md-4">
                        <div class="for-full">
                            <div class="game-11t5">
                                ...
                                <p class="msg4">
                                    <span>{{Number(entrance.syxw.jackpot)}}</span><i> {{formateCoinType(entrance.syxw.cointype)}}</i>
                                </p>
                    ...
                    <div class="col-xs-12 col-md-4">
                        <div class="for-full">
                            <div class="game-slot">
                                ...
                                <p class="msg3">Jackpot</p>
                                <p class="msg4">
                                    <span>{{Number(entrance.slot.jackpot)}}</span><i> {{formateCoinType(entrance.slot.cointype)}}</i>
                                </p>
                    ...
                    <div class="col-xs-12 col-md-4">
                        <div class="for-full">
                            <div class="game-onecoin">
                                ...
                                <p class="msg4">
                                    <span>{{Number(entrance.megacoin.goodsvalue)}}</span><i> {{formateCoinType(entrance.megacoin.cointype)}}</i>
                                </p>
    ...
    .items-msg {
        ...
        .item-recent {
            ...
            .tab-t {
                ...
                height: 30px;
                line-height: 30px;
                &.lucky11 .lucky11, &.slot .slot, &.luckycoin .luckycoin ,&.recharge .recharge ,&.withdraw .withdraw {
                    color: #788ca3;
