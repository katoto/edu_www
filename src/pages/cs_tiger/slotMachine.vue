            ...
            <div class="tiger-main" @click="initPop">
                <div class="tiger ">
                        ...
                        <a href="javascript:;" id="controlShowMsg" class="btn-main " :class="{disable:btnDisable && !isAutoPlay}">
                            ...
                            <template v-if="hideBarLycky">
                                ...
                                <div class="btn btn-free" @touchstart="touStart" @touchend="touEnd('isFree')" @mousedown="touStart" @mouseup="touEnd('isFree')" :class="{'hide':!parseFloat(free_times)}">
                                    ...
                                    <div v-if="parseFloat(free_times)>1">{{ free_times }} <lang>Chances</lang>
                                    </div>
                                    <div v-else>{{ free_times }} <lang>Chance</lang>
                                    </div>
                                </div>
                    ...
                    <div class="pop help" :class="{show:isShowHelp}">
                        ...
                        <ul class="tab-t">
                            <li :class="{on:tab_t===1}" @click="tab_t=1"><a href="javascript:;">
                                    <lang>Winning Table</lang>
                                </a></li>
                            <li :class="{on:tab_t===2}" @click="tab_t=2"><a href="javascript:;">
                                    <lang>Lucky Prize</lang>
                                </a></li>
                            <li :class="{on:tab_t===3}" @click="tab_t=3"><a href="javascript:;">
                            ...
                            <li :class="{on:tab_t===2}">
                                ...
                                <div class="msg">
                                    <p>
                                        <span class="bold">
                                            <lang>Jackpot</lang>
                                        </span>: <lang>2% of the player's bet amount is poured into Jackpot</lang>.
                                    </p>
                                    <p>
                                        <span>
                                        ...
                                        <span>
                                            <lang>appear at the same time in 9-line slot</lang>.
                                        </span>
                                    </p>
                                </div>
                                <div class="msg" v-if="currBalance.cointype==='2001'">
                                    <p>· <lang>Place 0.001 ETH per line, you can get 5% of the Jackpot</lang>
                                    </p>
                                    <p>· <lang>Place 0.001 ETH per line, you can get 50% of the Jackpot</lang>
                                    </p>
                                    <p class="hide">· <lang>Place 0.01 ETH per line, you can get 50% of the Jackpot</lang>
                                    </p>
                                </div>
                                <div class="msg" v-if="currBalance.cointype==='1001'">
                                    <p>· <lang>Place 0.00001 BTC per line, you can get 5% of the Jackpot</lang>
                                    </p>
                                    <p>· <lang>Place 0.0001 BTC per line, you can get 50% of the Jackpot</lang>
                                    </p>
                                    <p class="hide">· <lang>Place 0.01 ETH per line, you can get 50% of the Jackpot</lang>
                                    </p>
                                </div>
                                ...
                                <div class="msg">
                                    <p>
                                        <span class="bold">
                                            <lang>Lucky Bar</lang>
                                        </span>: <lang>If you did not win, one line bet can accumulate one lucky point in Lucky Bar</lang>
                                    </p>
                                    <p>
...
.operating {
  ...
  .single {
    ...
    .msg {
      ...
      i {
        display: block;
        background: url("../../assets/img/tiger/icon-arrow.png") no-repeat
          center;
        background-size: cover;
        width: 15/2px;
        height: 9/2px;
...
@media (max-width: @screen-phone) {
  ...
  .tiger-contain {
    background: #000 url("../../assets/img/tiger/bg-tiger-bak.png") no-repeat
      center top;
    background-size: 100%;
    height: 100%;
  }
