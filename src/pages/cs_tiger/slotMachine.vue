            ...
            <div class="tiger-main" @click="initPop">
                <div class="tiger ">
                        ...
                        <a href="javascript:;" class="btn-main " :class="{disable:btnDisable && !isAutoPlay}">
                            ...
                            <template v-if="hideBarLycky">
                                ...
                                <div class="btn btn-free" @touchstart="touStart" @touchend="touEnd('isFree')" @mousedown="touStart" @mouseup="touEnd('isFree')" :class="{'hide':!parseFloat(free_times)}">
                                    ...
                                    <div v-if="parseFloat(free_times)>1">{{ free_times }}
                                        <lang>Chances</lang>
                                    </div>
                                    <div v-else>{{ free_times }}
                                        <lang>Chance</lang>
                                    </div>
                                </div>
                    ...
                    <div class="pop help" :class="{show:isShowHelp}">
                        ...
                        <ul class="tab-t">
                            <li :class="{on:tab_t===1}" @click="tab_t=1">
                                <a href="javascript:;">
                                    <lang>Winning Table</lang>
                                </a>
                            </li>
                            <li :class="{on:tab_t===2}" @click="tab_t=2">
                                <a href="javascript:;">
                                    <lang>Lucky Prize</lang>
                                </a>
                            </li>
                            <li :class="{on:tab_t===3}" @click="tab_t=3">
                                <a href="javascript:;">
                                    <lang>Winning Line</lang>
                                </a>
                            </li>
                        </ul>
                        <ul class="tab-c">
                            <li :class="{on:tab_t===1}">
                                ...
                                <div class="winningamount">
                                    <p>
                                        <lang>Winning Amount</lang> =</p>
                                    <p>
                                        <lang>Multiple * Single Line</lang>
                                    </p>
                                </div>
                                <div class="details">
                                ...
                                <ul class="special">
                                    <li>
                                        ...
                                        <p>
                                            <lang>WILD: It can be paired with any 2 of the identical icons to form as 3 identical icons except for whistle icon (SCATTER)</lang>
                                        </p>
                                    </li>
                                    <li>
                                        <div class="icon">
                                        ...
                                        <p>
                                            <lang>SCATTER</lang>:</p>
                                        <p>
                                            <lang>Certain numbers of SCATTER can be exchanged into free spins:</lang>
                                        </p>
                                        <p>
                                            <lang>3 SCATTERs = 1 spin</lang>
                                        </p>
                                        <p>
                                            <lang>4 SCATTERs = 3 spins</lang>
                                        </p>
                                        <p>
                                            <lang>5 SCATTERs = 10 spins</lang>
                                        </p>
                                    </li>
                                </ul>
                            </li>
                            <li :class="{on:tab_t===2}">
                                ...
                                <div class="msg">
                                    <p>
                                        ...
                                        <lang>2% of the player's bet amount is poured into Jackpot</lang>.
                                    </p>
                                    <p>
                                        <span>
                                            <lang>You win if 9</lang>
                                        </span>
                                        &nbsp;<img width="16" height="16" src="@/assets/img/tiger/icon-England.png" alt="England">&nbsp;
                                        <span>
                                            <lang>appear at the same time in 9-line slot</lang>.</span>
                                    </p>
                                </div>
                                <div class="msg">
                                    <p>·
                                        <lang>Place 0.001 ETH per line, you can get 5% of the Jackpot</lang>
                                    </p>
                                    <p>·
                                        <lang>Place 0.001 ETH per line, you can get 50% of the Jackpot</lang>
                                    </p>
                                    <p class="hide">·
                                        <lang>Place 0.01 ETH per line, you can get 50% of the Jackpot</lang>
                                    </p>
                                </div>
                                <div class="line-divi">
                                    <div>
                                ...
                                <div class="msg">
                                    <p>
                                        ...
                                        <lang>If you did not win, one line bet can accumulate one lucky point in Lucky Bar</lang>
                                    </p>
                                    <p>
                    ...
                    <div class="pop pop-recharge" :class="{'show':showRecharge}">
                        ...
                        <div class="title">
                            ...
                            <p>(
                                <lang>only supports ETH</lang>)</p>
                        </div>
                        <div class="copy" v-if="userInfo && userInfo.accounts">
                            <a href="javascript:;" rel="nofollow" v-clipboard:copy="userInfo.accounts[0].address" v-clipboard:success="copySucc" v-clipboard:error="copyError">COPY</a>
                            <p v-if="userInfo && userInfo.accounts">{{ userInfo.accounts[0].address }}</p>
                        </div>
                        <div class="msg">
                            <lang>or scan to get the address</lang>
                        </div>
                        <img v-if="userInfo && userInfo.accounts" :src="'http://mobile.qq.com/qrcode?url='+ userInfo.accounts[0].address " alt="recharge">
                    </div>
                </div>
                <div class="tiger-pc-msg">
                    ...
                    <div class="tiger-firstBaxi" :class="{'show':showFirstBaxi}">
                        <p class="firstp">Try Slot & Win
                            <span class="winColor">97%+</span> Return Rate</p>
                    ...
                    <div class="contact">
                        <div class="fl">
                            <div class="msg1">
                                <lang>Scan to experience mobile webview</lang>
                            </div>
            ...
            if (this.userInfo && this.userInfo.accounts[0]) {
                if (
                    parseFloat(this.userInfo.accounts[0].balance) <
                        formatFloat(
                            parseFloat(this.dft_line) * parseFloat(this.dft_bet)
                        ) &&
...
.bg-slot {
    ...
    overflow: hidden;
    transition: all 0.2s;
    background: url("../../assets/img/tiger/bg-slot-run.png") no-repeat top
        center;
    background-size: contain;
    opacity: 0;
}
...
.operating {
    ...
    .single {
        ...
        .msg {
            ...
            i {
                display: block;
                background: url("../../assets/img/tiger/icon-arrow.png")
                    no-repeat center;
                background-size: cover;
                width: 15/2px;
                height: 9/2px;
    ...
    .bar {
        ...
        .bar-lycky {
            ...
            width: 53/2px;
            height: 52/2px;
            background: url("../../assets/img/tiger/icon-lucky.png") no-repeat
                center;
            background-size: cover;
...
.reward-small {
    ...
    &.double&.show {
        ...
        &::before {
            ...
            width: 98/2px;
            height: 98/2px;
            background: url("../../assets/img/tiger/double.png") no-repeat
                center;
            background-size: cover;
        }
    }
...
.reward-big {
    ...
    &:before {
        ...
        content: "";
        display: block;
        background: url("../../assets/img/tiger/reward-big.png") no-repeat
            center;
        background-size: cover;
        width: 443/2px;
        height: 251/2px;
...
.help {
    ...
    .title {
        ...
        color: #fff;
        font-family: sans-eb;
        background: url("../../assets/img/tiger/bg-helpTitle.png") no-repeat
            center;
        background-size: cover;
        p {
            position: absolute;
        ...
        .line-divi {
            ...
            div {
                ...
                &::after {
                    ...
                    position: absolute;
                    bottom: 4px;
                    background: url(../../assets/img/tiger/start.png) no-repeat
                        center;
                    background-size: cover;
                    width: 7px;
                    height: 7px;
...
@media (max-width: @screen-phone) {
    ...
    .tiger-contain {
        background: #000 url("../../assets/img/tiger/bg-tiger-bak.png")
