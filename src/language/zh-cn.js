module.exports = {
    ...
    '1. What is LuckyCoin?': '1. 什么是Lucky Coin？',
    '3. Example': '3. 玩法举例',
    '4. Draw': '4. 游戏怎么开奖？',
    '5. Refund': '5. 退款',
    ...
    'BTC': 'BTC',
    'ETH': 'ETH',
    'Eligible user can withdraw bonus! Still need {0} {1} transfer to be eligible!': 'Eligible user can withdraw bonus! Still need {0} {1} transfer to be eligible!',
    ...
    /* 验证页面 start */
    'Welcome to Coinsprize, experience your new gaming journey here! As a game platform based on Ethereum, Coinsprize is fair, just and open. All information on Ethereum cannot be modified, you can check draw details to see open and transparent  information any time.': '欢迎来到Coinslot，开启全新的博彩体验！Coinslot是一个公平公正公开、开奖绝对透明的游戏平台，平台基于以太坊，使用区块链技术来保证开奖结果，开奖号码，投注记录不可篡改。',
    'Games': '游戏',
    'Lucky 11': '幸运11',
    ...
    'Blockchain hash value': '区块链hash值',
    ...
    'Support ETH and BTC Bid': 'ETH、BTC多币种投注',
    'Currently,  popular coins ETH and BTC are supported on the platform to bid, top up and withdraw. More coins will be supported in the near future.': '当前游戏支持最受欢迎的比特币和以太币进行投注、存款和提款，未来还将接受更多加密数字货币，敬请期待',
    'Support Mobile APP': '支持移动端设备',
    'Enjoy conveniece and fun from quick bid and fair play at any time & any where.': '随时随地投注、充值、提款，做你更贴心、更便捷的，更放心的平台。欢迎下载Android版本，iOS版本敬请期待',
    'Finally! You found the wonderland---- Coinslot, a blockchain-based game platform with fairness and openness': '欢迎来区块链游戏平台',
    ...
    'Finished ': 'Finished ',
    'Draw expired. Your payment has been refunded.': '场次已过期，用户的投注金额已返还到用户账户上',
    'Draw expired. Your {0} {1} has been refunded.': '场次已过期，您的投注金额{0} {1}已返还到您的账户上',
    'Max': '最大',
    'Draw finished at': '开奖时间',
    'Time Up!': '已结束!',
    'Draw expired.': '已过期',
    "User's payment has been refunded.": "User's payment has been refunded.",
    'Detail >>': '查看详情 >>',
    ...
    'You have been Bet {0} {1}': 'You have been Bet {0} {1}',
    'Your {0} {1} has been refunded.': 'Your {0} {1} has been refunded.',
    'You get five numbers obtained bonus {0}{1}. The more bets, the higher the probability of winning, I wish you good luck~ ': 'You get five numbers obtained bonus {0}{1}. The more bets, the higher the probability of winning, I wish you good luck~ ',
    'Your balance can be purchased for {0}{1}. If you need to bet more, please top up first.': 'Your balance can be purchased for {0}{1}. If you need to bet more, please top up first.',
    'Bet Time': 'Bet Time',
    ...
    'You bet {0} {1} to get {2} numbers': 'You bet {0} {1} to get {2} numbers',
    'You have {0} bidding numbers. Bid more, win more!': 'You have {0} bidding numbers. Bid more, win more!',
    'Reward is here: Blockchain-based draw': 'Reward is here: Blockchain-based draw',
    'Available bid is here: Draw after all bids sold out': 'Available bid is here: Draw after all bids sold out',
    'Click here to play: Bid more, win more': 'Click here to play: Bid more, win more',
    'Win Instant Reward': 'Win Instant Reward',
    'Small cost, big profit!': 'Small cost, big profit!',
    'How To Play ?': '怎么玩 ?',
    'More >': '更多 >',
