module.exports = {
    ...
    'Sign gift': '签到送',
    'Sign Up to Get 1CC for Free': '注册即可领取免费1CC',
    ...
    'The maximum withdrawal is {0} {1}': '您当前最大可提款金额为{0} {1}',
    ...
    'SlotMachine': '老虎机',
    'LuckyPoker': '幸运扑克',
    'Win <i class=bold>98%+</i> Return Rate': '高达<i class=bold>98%</i>返奖率',
    ...
    /* 一元夺币 end */
    'General：support@coinsprize.com': '咨询邮箱：support@coinsprize.com',
    ...
    'Buyers who hold part/all of first 500 tickets enjoy 10% betting dividend.': '每轮前500个Ticket购买者可获得后面购买者的10%投注分红！',
    'Buy more tickets, get more dividend, and enjoy higher winning chance.': '购买越多，分红越多，中奖概率也越高',
    'Click Instructions to learn easy play for starters': '点击下方的游戏教程，可查看“新手引导”噢！',
    ...
    'SuperCoin is a crowdfunding game based on blockchain technology. 0.01 ETH bet can win 10 ETH or more!': 'SuperCoin是一款基于区块链技术的类众筹游戏，在这里您可以使用如0.01ETH的小付出去赢得10个ETH甚至更多的数字货币奖励！',
    'Gameplay:': '游戏规则：',
    '1. At the beginning of the game, there will be a 10 ETH-prize pool and 1500 random numbers. And each ticket corresponds to a random number. After all tickets are sold out or time\'s up, the draw will proceed. If your ticket number matches draw number, you win the reward from prize pool (at least 10 ETH).': '1. 游戏会在初始轮赠送出10ETH的初始奖金，并初始化1500个随机号码。每个用户通过购买票可获得一个随机派送的号码，当每轮倒计时结束后（或者总份数销售完毕时），本场次将进行开奖。当开奖号码和您获得的随机号码一致时，你将赢得奖池里一定比例的金额（大于或等于10ETH）。',
    '2. Share the dividend. Buyers who hold part/all of first 500 tickets of a round enjoy 10% betting dividend. More tickets bring more dividend.': '2. 分红优势：每一轮前500张票的购买，都可以获得后面购买人的10%投注佣金，购票越多，分红越多。',
    ...
    'This round you\'ve invited: {0} friends': '本轮您已邀请: {0}人',
    'This round you\'ve invited: {0} friend': '本轮您已邀请: {0}人',
    'You bought {0} ticket in round {1}': '第{1}期，您已购买{0}人次',
    'You bought {0} tickets in round {1}': '第{1}期，您已购买{0}人次',
    'No winner of this round.': '本次无人中奖,',
    'Congratulations! "{0}" Wins': '恭喜 "{0}" 获奖',
