let en = {
    ...
    a45: '1. Client Seed: a string of characters provide to you before placing a bet.',
    ...
    a56: 'Then uses the first 5 characters of the bet hash to generate the outcome of your bet. The system does this by converting the first 5 characters of the bet hash from base 16 (hexadecimal) to base 10 (decimal).',
    a57: 'The decimal number is used to calculate the bet result through the modulo 54 operation, and 0-53 corresponds to 54 types of the playing card.',
