module.exports = {
    ...
    'Select Coin': '當前選擇',
    'copy Address': '複製連結',
    'Tips: This address only supports ETH top-up, do not choose another kind of coins': '溫馨提示：只支持ETH位址轉帳',
    'Tips: This address only supports BTC top-up, do not choose another kind of coins': '溫馨提示：只支持BTC位址轉帳',
    ...
    'Top-up needs to be confirmed by network node. Transfer will be successful after one confirmation, and you can withdraw the balance after six confirmations.': '您充值至上述位址後，需要整個網路節點的確認，1次網路確認後到賬，6次網路確認後可提幣.',
    ...
    'Slot-- A High Frequency Ether Game Supports Bitcoin and Ethereum Play-- Coinsprize': 'slot-壹款基於以太坊區塊鏈技術開發的以太幣、比特幣高頻賭場遊戲-coinsprize',
    'Slot, blockchain-based casino game, Ethereum casino game, bitcoin casino game, high frequency bitcoin play, token bet': 'slot,區塊鏈賭場遊戲,以太坊賭場遊戲,比特幣賭場遊戲,比特幣高頻賭場遊戲，token投註遊戲',
    'Slot is a blockchain-based high frequency casino game developed by Coinsprize. Players can win rewards from easy games on the platform. Since games are based on blockchain, the draw is open, transparent and checkable. Try your luck and experience exciting games now!': 'slot是coinsprize公司旗下開發的壹款基於以太坊區塊鏈技術的高頻賭場遊戲。遊戲玩法簡單，玩家可以自主選擇使用以太幣或者比特幣進行遊戲來賺取對應的獎品。遊戲開獎公開、透明並且可追溯，快來測測您的運氣，贏取比特幣和以太幣，體驗不壹樣的刺激玩法吧。',
