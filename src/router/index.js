...
/* 协议 */
const cs_protocol_policy = () =>
import
('~/pages/cs_protocol/policy')
const cs_protocol_terms = () =>
import
('~/pages/cs_protocol/terms')

/*个人中心*/
const account = () =>
import
("~/pages/cs_account/account")
const General = () =>
import
("~/pages/cs_account/General")
const Deposit = () =>
import
("~/pages/cs_account/Deposit")
const MyBets = () =>
import
("~/pages/cs_account/MyBets")
const MyTransactions = () =>
import
("~/pages/cs_account/MyTransactions")
const Withdraw = () =>
import
("~/pages/cs_account/Withdraw")
