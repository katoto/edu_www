        ...
        <div class="head">
            <div class="top">
                ...
                <div class="choose-play icon-new ">
                    ...
                    <router-link :to="{path: '/luckyPoker/'}" active-class="on" class="nav_poker">
                        {{$lang.poker.a39}}
                    </router-link>
                                ...
                                <div class="currency-select">
                                    ...
                                    <ul>
                                        <li v-for="(item, index) in userInfo.accounts" :key="index" :class="{'on': item.cointype === currBalance.cointype }" @click="changeAccounts( item )">
                                            ...
                                            <a v-if="currBalance.cointype==='2001'" class="address" v-clipboard:copy="currBalance.address" v-clipboard:success="copySucc" v-clipboard:error="copyError">{{ item.address }}</a>
                                            ...
                                            <a v-if="currBalance.cointype==='1001'" class="address" v-clipboard:copy="currBalance.address" v-clipboard:success="copySucc" v-clipboard:error="copyError">{{ item.address }}</a>
                                            <a v-if="currBalance.cointype==='2000'" class="address" v-clipboard:copy="currBalance.address" v-clipboard:success="copySucc" v-clipboard:error="copyError">{{ item.address }}</a>
                                        </li>
                                        <!--<li>-->
                ...
                <!--拉新活動 on 水龙头new -->
                <div class="cs-faucet" v-if="isLog && false">
                    <div>
                    ...
                    <!--浮层 -->
                    <!--第一次登陆 -->
                    <section v-if="showFirstLogin && isLog && false">
                        <div class="newFirst">
                            <div class="msg">
                                <p>
    ...
    * {
    ...
    .cnt {
        ...
        h2 {
            ...
            font-family: sans-eb;
            font-weight: bold;
            background: url("../assets/img/paysend/fir_titlebg.png") no-repeat
                center;
        ...
        .btnclose {
            ...
            background: url("../assets/img/paysend/btn-close.png") no-repeat
                center;
...
.head {
    ...
    .choose-play {
        ...
        .nav_gift {
            ...
            &.on {
                background-image: url(" ../assets/img/icon-gift-on.png");
            }
        }
        .nav_slot {
            background-image: url(" ../assets/img/icon-slot.png");
            &.on {
                background-image: url(" ../assets/img/icon-slot-on.png");
            }
        }
        .nav_poker {
            background-image: url(" ../assets/img/icon-poker.png");
            &.on {
                background-image: url(" ../assets/img/icon-poker-on.png");
            }
        }
        .nav_coin {
            background-image: url(" ../assets/img/icon-coin.png");
            &.on {
                background-image: url(" ../assets/img/icon-coin-on.png");
            }
        }
        .nav_lotto {
            background-image: url(" ../assets/img/icon-lotto.png");
            &.on {
                background-image: url(" ../assets/img/icon-lotto-on.png");
            }
        }
        .nav_dapp {
            background-image: url(" ../assets/img/icon-dapp.png");
            &.on {
                background-image: url(" ../assets/img/icon-dapp-on.png");
            }
        }
        &.icon-new {
            &::before {
    ...
    .mycount {
        ...
        .countNum {
            ...
            i {
                ...
                right: 0;
                top: 9px;
                background: url(" ../assets/slice/arrow-down-fff.png") no-repeat
                    center;
            ...
            li.on {
                a {
                    ...
                    &::after {
                        width: 57/2px;
                        height: 53/2px;
                        background: url("../assets/img/icon-select.png")
                            no-repeat center;
