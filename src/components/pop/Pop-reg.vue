  ...
  <Pop class="pop-reg" :show.sync="show">
    <div class="pop-main">
      ...
      <form>
        ...
        />
        <input type="password" v-model="reg_againPass" :placeholder="_('Confirm Password')" />
        <div class="verCode">
        ...
        <input
          type="submit"
          @click.stop.prevent="submitReg"
          :value="_('Sign Up')"
          :class="{
            no: !log_checked || reg_email === '' || reg_pass === '' || reg_againPass === '' || verifyCode === ''
          }"
        />
      </form>
